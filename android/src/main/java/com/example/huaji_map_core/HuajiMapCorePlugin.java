...
import com.example.huaji_map_core.sub_handler.*;
import com.example.huaji_map_core.sub_handler.custom.SubHandlerCustom;
...
public class HuajiMapCorePlugin implements FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware  {
 private static List<Map<String, Handler>> handlerMapList;

    // v1 android embedding for compatible
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "com.example/huaji_map_core", new StandardMethodCodec(new FluttifyMessageCodec()));

        HuajiMapCorePlugin plugin = new HuajiMapCorePlugin();
        ...
        platformViewRegistry.registerViewFactory("com.example/com.amap.api.maps.offlinemap.DownloadProgressView", new DownloadProgressViewFactory(messenger, activity));
        platformViewRegistry.registerViewFactory("com.example/com.amap.api.maps.TextureMapView", new TextureMapViewFactory(messenger, activity));
        platformViewRegistry.registerViewFactory("com.example/com.amap.api.maps.WearMapView", new WearMapViewFactory(messenger, activity));
        platformViewRegistry.registerViewFactory("com.example/com.amap.api.maps.MapView", new MapViewFactory(messenger, activity));
    }
    ...
    public void onAttachedToEngine(FlutterPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "HuajiMapCorePlugin::onAttachedToEngine@" + binding);
        }

        final MethodChannel channel = new MethodChannel(binding.getBinaryMessenger(), "com.example/huaji_map_core", new StandardMethodCodec(new FluttifyMessageCodec()));
    ...
    public void onDetachedFromEngine(FlutterPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "HuajiMapCorePlugin::onDetachedFromEngine@" + binding);
        }
    }
    ...
    public void onAttachedToActivity(ActivityPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "HuajiMapCorePlugin::onAttachedToActivity@" + binding);
        }
    ...
    public void onDetachedFromActivity() {
        if (getEnableLog()) {
            Log.d("fluttify-java", "HuajiMapCorePlugin::onDetachedFromActivity");
        }
    }
    ...
    public void onReattachedToActivityForConfigChanges(ActivityPluginBinding binding) {
        if (getEnableLog()) {
            Log.d("fluttify-java", "HuajiMapCorePlugin::onReattachedToActivityForConfigChanges@" + binding);
        }
    }
    ...
    public void onDetachedFromActivityForConfigChanges() {
        if (getEnableLog()) {
            Log.d("fluttify-java", "HuajiMapCorePlugin::onDetachedFromActivityForConfigChanges");
        }
    }
